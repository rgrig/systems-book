...
\begin{theorem}[{Sleator and Tarjan~1985}]\label{th:fifo-lru-almost-optimal}
...
\item[{[4]}]
  Belady,
  \emph{A Study of Replacement Algorithms for Virtual Storage Computers},
  1966
\item[{[5]}]
  Sleator and Tarjan,
  \emph{Amortized Efficiency of List Update and Paging Rules},
  1985
\end{itemize}
